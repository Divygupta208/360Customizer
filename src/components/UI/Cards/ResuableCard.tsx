      ...
      <div className={styles.card}>
        <div className={styles["top-container"]}>
          <img
            src={
              data?.profilePicture ||
              "https://i.pinimg.com/originals/fe/6c/ed/fe6ced49bdc3d7b98c04f7b12c2f2656.jpg"
            }
            alt={data?.name}
        ...
        <div className={styles["bottom-container"]}>
          ...
          <h3 className={styles["user-role"]}>
            {data?.role || "role"} @ {data?.organisation || "organization"}
          </h3>
          <p className={styles.bio}>{data?.bio || "just another bio"}</p>
