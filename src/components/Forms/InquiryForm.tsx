...
const InquiryForm = () => {
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    try {
      const res = await simulatedApi(data);
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center px-4 py-4 bg-gray-50">
      <div className="w-full max-w-md">
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="w-full min-w-[400px] bg-white border border-gray-300 rounded-lg p-6 shadow-xl space-y-4"
        >
          <h3 className="text-center text-white font-bold uppercase bg-indigo-600 rounded-xl p-4">
            Inquiry Form
          </h3>
